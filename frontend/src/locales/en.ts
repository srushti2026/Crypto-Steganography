export const en = {
  ...
  hero: {
    subtitle: "ADVANCED STEGANOGRAPHY PLATFORM",
    title: "Invisible Data Protection at Your Fingertips",
    description: "Secure your sensitive information with military-grade encryption and invisible watermarking. VeilForge makes data protection seamless and undetectable.",
    bookStay: "Get Started Free",
    exploreApartments: "Explore Platform",
  ...
  testimonials: {
    title: "What Security Professionals Say",
    description: "Discover why enterprises and security experts trust VeilForge for invisible data protection."
  },
  notFound: {
