export const it = {
  ...
  hero: {
    subtitle: "PIATTAFORMA STEGANOGRAFICA AVANZATA",
    title: "Protezione Dati Invisibile a Portata di Mano",
    description: "Proteggi le tue informazioni sensibili con crittografia di livello militare e watermarking invisibile. VeilForge rende la protezione dei dati semplice e non rilevabile.",
    bookStay: "Inizia Gratuitamente",
    exploreApartments: "Esplora la Piattaforma",
  ...
  testimonials: {
    title: "Cosa Dicono i Professionisti della Sicurezza",
    description: "Scopri perché aziende ed esperti di sicurezza si fidano di VeilForge per la protezione invisibile dei dati."
  },
  notFound: {
